                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="{{url('master/jasaDefault/list')}}">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                  ...
                                  @endif
                                    <!-- Basic Examples -->
                                    <form method="POST" action="{{url('master/jasaDefault/listWithSearch')}}">
                                                ...
                                                <span class="input-group-addon">
                                                  ...
                                                  <table class="table table-striped">
                                                      ...
                                                      @foreach($data as $jasad)
                                                        ...
                                                        <tr  class="{{ $jasad->hided == 1 ? 'danger' : '' }}">
                                                            <td><a href="{{url('master/jasaDefault/edit')}}/{{$jasad->kdJasaDefault}}"><i class="material-icons">edit</i></a></td>
                                                            <td>{{$jasad->nama}}</td>
                                                            <th>{{$jasad->harga}}</th>
                                                        </tr>
                                                          @endforeach
